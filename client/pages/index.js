      ...
      <div className=" border-2 border-gray-400  bg-[#f2cda6] rounded-lg text-[#002b6f] my-4 mx-20">
        <div className="flex justify-center py-8 flex-col items-center">
          <div className="py-16 my-2 text-black text-center rounded-md">
            ...
            <input
              class="block w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 p-2 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
              id="file_input"
              type="file"
            ></input>
